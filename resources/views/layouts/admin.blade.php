          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
               <li><a href="{{route('categoria.cadastrar')}}"><i class="fa fa-circle-o"></i>Registar Categoria</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{route('usuario.cadastrar')}}"><i class="fa fa-circle-o"></i>Cadastrar Usuarios</a></li>
